 ...
 * Categorias Model
 *
 * @property \Cake\ORM\Association\HasMany $Automovils
 *
...
class CategoriasTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->decimal('poincremento_alquiler')
            ->requirePresence('poincremento_alquiler', 'create')
            ->notEmpty('poincremento_alquiler');
